package ganymedes01.etfuturum.api.blocksanditems;
...
public interface IReferenceBase<T> {
    ...
    default ItemStack newItemStack(int count, int meta) {
        ...
        throw new IllegalStateException("This error is being reached because some mod messed with an Et Futurum class using reflection, or implemented it incorrectly!");
    }
